...
from agentforge.models.artifacts import AgentCard, AgentCardAuthentication, AgentCardSkill
...
class AgentCardGenerator:
    ...
    def generate(self, tool_set: ComposedToolSet, config: AgentForgeConfig) -> AgentCard:

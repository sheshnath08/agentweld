"""Entry-point discovery for third-party agentforge adapter plugins.

Third-party packages advertise adapters via the ``agentforge.adapters``
...
from agentforge.utils.errors import PluginError

if TYPE_CHECKING:
    from agentforge.sources.base import SourceAdapter

_ENTRY_POINT_GROUP = "agentforge.adapters"

"""Core ToolDefinition model — the lingua franca of the agentweld pipeline."""
...
class ToolDefinition(BaseModel):
    ...
    # Provenance
    source_id: str = Field(description="Which source entry in agentweld.yaml this came from.")
